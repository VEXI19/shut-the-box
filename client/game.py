...
def change_current_scene(new_scene):
    global current_screen
    current_screen = new_scene

client2.client_receive_service.change_current_scene = change_current_scene
# Game code
game_code = ""
        ...
        if current_screen == START_SCREEN:
            if event.type == pygame.MOUSEBUTTONDOWN:
                if create_game_button.collidepoint(event.pos):
                    ...
                    client2.client_request_service.join_session_request()
                    text = ''
